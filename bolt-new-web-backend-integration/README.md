# Build Your Website with Bolt.new + Smartformify
...
While your user interface may appear fully designed, form actions will fail without an active endpoint target.
